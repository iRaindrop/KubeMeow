---
title: "Flatcar Security"
type: concept
sources:
  - raw/topics/flatcar/content/docs/latest/security/
related:
  - "[[flatcar-overview]]"
  - "[[flatcar-os-config]]"
  - "[[flatcar-devguide]]"
...
SELinux is supported. **Known issue:** Flannel >0.17.0 does not work with enforced SELinux ([flatcar#779](https://github.com/flatcar/Flatcar/issues/779)).
...
## Certificate Authority & Auth (`security/cert-auth/`)
...
## Constants and IDs (`security/constants-and-ids.md`)
