---
title: "Flatcar Updates & Releases"
type: concept
sources:
  - raw/topics/flatcar/content/docs/latest/updates-releases/
related:
  - "[[flatcar-overview]]"
  - "[[flatcar-os-config]]"
  - "[[flatcar-diagnostics]]"
...
## Release Channels (`updates-releases/releases/`)
...
## Reboot Strategies (`updates-releases/releases/update-strategies.md`)
...
## update.conf (`updates-releases/releases/update-conf.md`)
...
## Verifying Images (`updates-releases/releases/verify-images.md`)
...
## Nebraska Update Manager (`updates-releases/nebraska/`)
...
**OEM payloads:** Self-hosted Nebraska must serve OEM sysext payloads (introduced in Flatcar 3760.0.0). Keep Nebraska up to date.
